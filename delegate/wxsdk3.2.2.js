!function (e, t) {
    ...
    return function (e) {
        ...
        var u = function (e, t) {
            ...
            d.ns = 1, d.payload = h, s.debug("⬆︎ thirdMessage: ", d);
            ...
            v.version = t.version, v.encryptType = t.encryptType, v.command = 0, v.guid = t.context.jid, v.payload = m, s.debug("⬆︎ MSync: ", v), v = g.encode(v).finish(), t.sendMSync(v)
        }, l = function (e, t, o) {
            i = o;
            var r = t || this;
        ...
        h.fromJSON = function (e, t) {
            ...
            if ("string" == typeof t) u = JSON.parse(t); else {
                if ("object" !== (0, r.default)(t)) return void console.log("pb格式转化失败");
                u = t
            }
        ...
        O.prototype.registerUser = function (e) {
            ...
            s.queue = t, s.key = new f.default(e.low, e.high, e.unsigned).toString(), s = n.encode(s).finish(), m.debug("⬆︎_lastsession: ", s);
        ...
        O.prototype._metapayload = function (e, t, o) {
            for (var r = 0; r < e.length; r++) {
                ...
                _.indexOf(i) < 0 && (m.debug("下行meta：", e[r]), 1 === e[r].ns ? (0, p.default)(e[r], t, o) : 2 === e[r].ns ? (0, c.default)(e[r], t, o) : 3 === e[r].ns ? h.default.handleMessage(e[r], t, o) : 0 === e[r].ns ? (0, d.default)(e[r], t, o) : 4 === e[r].ns && o.registerConfrIQHandler && o.registerConfrIQHandler(e[r], t, o), _.length <= 100 || _.shift(), _.push(i))
            }
            ...
            s.meta = r, m.debug("⬆︎ rebuild: ", r), s = n.encode(s).finish();
            ...
            n.queue = e, m.debug("⬆︎queue: ", n), n = r.encode(n).finish();
        ...
        var b = function (e) {
            ...
            o.version = e.version, o.encryptType = e.encryptType, o.command = 1, m.debug("⬆︎unreadDeal: ", o), o = t.encode(o).finish(), e._base64transform(o, e)
        };
        O.prototype._receiveProvision = function (e, t) {
            var o = i.lookup("easemob.pb.Provision").decode(e.payload);
            t.context.jid.clientResource = o.resource, t.clientResource = o.resource, 0 == o.status.errorCode ? (t.onOpened(), t.heartBeat(t), b(t), t._rebuild(t)) : t.isDebug && console.log("下行provision失败: ", o)
            ...
            return function (t) {
                ...
                return function (t, a) {
                    ...
                    for (var u = e.fieldsArray.slice().sort(s.compareFieldsById), l = 0; l < u.length; l++) {
                        ...
                        } else (!p.optional || null != f && t.hasOwnProperty(p.name)) && (p.optional || null != f && t.hasOwnProperty(p.name) || console.warn("注意啦!!!很大概率会报错 类型:", t.$type ? t.$type.name : "不晓得", "没有设置对应的属性:", p.name, "检查是不是proto文件属性设置为了required"), void 0 === d ? p.resolvedType.group ? n[c].encode(f, a.uint32((p.id << 3 | 3) >>> 0)).uint32((p.id << 3 | 4) >>> 0) : n[c].encode(f, a.uint32((p.id << 3 | 2) >>> 0).fork()).ldelim() : a.uint32((p.id << 3 | d) >>> 0)[h](f))
                    }
                    return a
                }
            }
                ...
                if (i = g(t), n.default.connection.prototype.sock = i, i.onOpen((function () {
                    ...
                    switch (console.log("result", o), o.command) {
                        ...
                        case 1:
                            ...
                            if (l = l.decode(o.payload), t.isDebug && console.log("下行CommUnreadDLMessage：", l), console.log("CommUnreadDLMessage", l), 0 === l.unread.length) ; else for (var c = 0; c < l.unread.length; c++) t._backqueue(l.unread[c].queue, t);
                            t._rebuild();
                            break;
                        case 2:
                            var d = f.lookup("easemob.pb.CommNotice").decode(o.payload);
                            if (t.isDebug && console.log("下行noticeMessage：", d), !1 !== p.default.checkArray(t._queues, d.queue)) return;
                            t._queues.push(d.queue), 1 == t._queues.length && t._backqueue(d.queue, t), this.qTimer && clearTimeout(this.qTimer), this.qTimer = setTimeout((function () {
                                var e = d.queue;
                                !1 !== p.default.checkArray(t._queues, e) && (t._backqueue(e, t), t.isDebug && console.log("上行q: ", e, t._queues, d.queue))
                            }), 2e4);
                            break;
                        case 3:
                            t._receiveProvision(o, t), t.isDebug && console.log("下行Provision：", o)
                    }
